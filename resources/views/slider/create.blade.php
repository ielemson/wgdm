        ...
        <div class="row">
            ...
            <div class="col-md-8 mx-auto">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="forms-sample" method="POST" enctype="multipart/form-data" action="{{route('slider.store')}}">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="exampleInputName1">{{ __('Header')}}</label>
                                        <input type="text" class="form-control " id="exampleInputName1" placeholder="Enter Header" name="header" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control" id="" placeholder="Enter Slider Content" name="content" required></textarea>
                                    </div>
                                </div>
