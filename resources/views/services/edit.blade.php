        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{route('service.update',$service->id)}}" method="POST" enctype="multipart/form-data" role="form" id="">
                        @csrf
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="header" type="text" value="{{$service->header}}" class="form-control @error('header') is-invalid @enderror" name="header" value="" placeholder="Enter service" required>
                              ...
                              <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    <img src="{{asset('assets/images/services')}}/{{$service->image}}" alt="" style="width: 50%">
                                </div>
